...
import { ChevronRight, User, Mail, Lock, Activity } from "lucide-react";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-gold-leaf transition-colors" size={18} />
              <input 

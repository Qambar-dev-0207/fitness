          ...
          >
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="text-[9px] font-mono uppercase tracking-[0.4em] text-white/30">Protein (g)</label>
                  <input 
              ...
              <button onClick={logCalories} className="w-full py-4 rounded-full bg-white text-void font-bold uppercase tracking-[0.3em] text-[10px] hover:bg-gold-leaf transition-all">
                Synchronize Log
              </button>
            </div>
                ...
                {logs.filter(l => l.type === "calorie").map((log, i) => (
                  <div key={i} className="flex justify-between items-center py-4 border-b border-white/5">
                    ...
                    <div className="text-right">
                      <div className="text-white font-mono text-lg">{log.cal} kcal</div>
